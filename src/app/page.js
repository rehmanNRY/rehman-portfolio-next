import ScrollOpacityText from "@/components/ChangeText";
    ...
    <div className="px-24">
      ...
      <section className="flex items-center justify-between">
        <div className="w-[52%] flex flex-col gap-4">
          <h2 className="text-7xl font-black"><ScrollOpacityText text="Me, Myself & I" /><span className="text-[#bb66e2]">.</span></h2>
      ...
      <section className="py-40">
        <div className="text-center">
          <h2 className="text-7xl font-black mb-4"><ScrollOpacityText text="Skills & Experience" /><span className="text-[#bb66e2]">.</span></h2>
      ...
      <section className="relative pb-40">
        <h2 className="text-7xl font-black mb-4"><ScrollOpacityText text="My Portfolio" /><span className="text-[#bb66e2]">.</span></h2>
      ...
      <section className="pb-20">
        <div className="text-center">
          <h2 className="text-7xl font-black mb-4"><ScrollOpacityText text="Latest Projects" /><span className="text-[#bb66e2]">.</span></h2>
